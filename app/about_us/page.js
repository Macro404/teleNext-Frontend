...
export default function AboutUs(){
    return <div className="about-container">
        ...
        <article>
            ...
            <h2>Site features</h2>
            <p>We've built a telecom site featuring products in the form of phones and subscriptions. We use google validation to enable signups to the page as well as for validating access.</p>
            <h2>Tech stack</h2>
            <h3>Front-end</h3>
            ...
            <h3>Data storage</h3>
            <p>All of our data is stored in a postgreSQL database.</p>
            <h3>Cloud</h3>
